//All this code is for setup an express server

const express = require('express'); //require modules, it could be a form
const app = express();
const port = process.env.PORT || 4343;
const database = require('./database');

//middleware to parse the content of the body of every request
